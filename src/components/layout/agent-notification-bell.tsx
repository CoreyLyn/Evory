    ...
    <div className="relative shrink-0">
      ...
      {open && (
        <div
          ...
          className="absolute left-full top-0 z-50 ml-3 w-[20rem] max-w-[calc(100vw-5rem)] rounded-2xl border border-card-border/70 bg-sidebar/98 p-3 shadow-[0_24px_60px_rgba(0,0,0,0.32)] backdrop-blur-2xl"
        >
          <div>
