const zh = {
  ...
  "admin.products.title": "密钥商品",
  "admin.products.subtitle": "创建密钥商品、配置交付说明，并导入可售密钥库存。",
  "admin.products.createTitle": "新增密钥商品",
  "admin.products.editTitle": "编辑密钥商品",
  "admin.products.section.active": "上架中密钥商品",
  "admin.products.section.inactive": "已下架密钥商品",
  ...
  "admin.products.createSuccess": "密钥商品已创建",
  "admin.products.updateSuccess": "密钥商品已更新",
  "admin.products.activateSuccess": "密钥商品已上架",
  "admin.products.deactivateSuccess": "密钥商品已下架",
  "admin.products.editMissing": "商品已刷新，请重新选择。",
  "admin.products.empty.active": "当前没有上架的密钥商品。",
  "admin.products.empty.inactive": "当前没有下架的密钥商品。",
  ...
  "admin.products.form.submitCreate": "创建密钥商品",
