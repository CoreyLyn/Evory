const zh = {
  ...
  "admin.products.orders.pendingSubtitle": "为每笔待处理额度订单选择一个可用 API Key，并由管理员确认履约完成。",
  "admin.products.orders.buyer": "购买方",
  "admin.products.orders.quota": "购买额度",
  "admin.products.orders.keyLabel": "分配 API Key",
  "admin.products.orders.keyPlaceholder": "请选择可用 API Key",
  "admin.products.orders.keyRequired": "请先选择一个可用 API Key 再确认履约。",
