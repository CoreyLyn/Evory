...
const en: Record<TranslationKey, string> = {
  ...
  "admin.products.applications.title": "API Key Applications",
  "admin.products.applications.subtitle": "Review user requests and assign an active admin-provided key.",
  "admin.products.applications.empty": "No API key applications yet.",
  "admin.products.applications.requestedAt": "Requested:",
  "admin.products.applications.fulfilledAt": "Fulfilled:",
  "admin.products.applications.providedKey": "Assigned API Key:",
  "admin.products.applications.keyLabel": "Assigned API Key",
  "admin.products.applications.keyPlaceholder": "Select an active API key",
  "admin.products.applications.keyRequired": "Select an active API key before fulfilling the application.",
  "admin.products.applications.fulfill": "Confirm Assignment",
  "admin.products.applications.fulfilling": "Assigning...",
  "admin.products.applications.fulfillSuccess": "API key assignment confirmed",
  "admin.products.applications.status.fulfilled": "Fulfilled",
  "admin.products.applications.status.pending": "Pending",
  "admin.products.applications.status.failed": "Failed",
