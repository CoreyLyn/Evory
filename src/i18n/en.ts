...
const en: Record<TranslationKey, string> = {
  ...
  "shop.secret.fulfillment": "Fulfillment",
  "shop.secret.fulfillmentStateLabel": "Order state",
  "shop.secret.fulfillmentStatePending": "Pending admin fulfillment",
  "shop.secret.fulfillmentTimingLabel": "Quota timing",
  "shop.secret.fulfillmentTimingValue":
    "Quota is added only after an admin fulfills the connected agent's order.",
  "shop.secret.purchasePolicy": "Purchase policy",
  "shop.secret.purchaseChannelLabel": "Purchase channel",
  "shop.secret.purchaseChannelAgentApi": "Connected agent via API",
  "shop.secret.orderTypeLabel": "Order type",
  "shop.secret.perAgentLimitLabel": "Per-agent limit",
  "shop.secret.noPerAgentLimit": "No published per-agent cap",
  ...
  "admin.products.form.providerPreset": "Provider Preset",
  "admin.products.form.providerPresetHint":
    "Choose a preset to fill the provider and unit fields, or switch to Custom before editing them manually.",
  "admin.products.form.providerPresetOpenAi": "OpenAI",
  "admin.products.form.providerPresetAnthropic": "Anthropic",
  "admin.products.form.providerPresetCustom": "Custom",
  ...
  "admin.products.form.purchasePolicy": "Purchase Policy",
  "admin.products.form.purchasePolicyHint":
    "Single limits each agent to one purchase, repeat removes the cap, and limited keeps repeats while enforcing a max count.",
  ...
  "admin.products.policy.repeat": "Repeat purchase",
  "admin.products.policy.single": "One per agent",
  "admin.products.policy.limited": "Up to {count} per agent",
  "admin.products.limit.unlimited": "Unlimited",
  "admin.products.limit.value": "{count} per agent",
  "admin.products.preview.title": "Storefront Preview",
  "admin.products.preview.subtitle":
    "This is the quick buyer-facing snapshot admins can use to sanity-check pricing and purchase rules before saving.",
  "admin.products.preview.provider": "Provider",
  "admin.products.preview.name": "Name",
  "admin.products.preview.quota": "Quota",
  "admin.products.preview.policy": "Policy",
  "admin.products.preview.price": "Price",
  ...
  "admin.products.applications.title": "Bound Account API Keys",
  "admin.products.applications.subtitle": "Review which user accounts are currently bound to admin-provided API keys.",
  "admin.products.applications.empty": "No bound account API keys yet.",
  "admin.products.applications.requestedAt": "Requested:",
  "admin.products.applications.fulfilledAt": "Fulfilled:",
  ...
  "admin.products.baseUrls.title": "Base URL",
  "admin.products.baseUrls.subtitle": "Configure the Base URLs shown on the My Agents API Key card; blank values are hidden on the user side.",
  "admin.products.baseUrls.openAiLabel": "Compatible with OpenAI protocol tools",
  "admin.products.baseUrls.anthropicLabel": "Compatible with Anthropic protocol tools",
  "admin.products.baseUrls.optionalHint": "Optional. Leave blank to hide that row on the user side.",
  "admin.products.baseUrls.save": "Save Base URL",
  "admin.products.baseUrls.saving": "Saving...",
  "admin.products.baseUrls.saveSuccess": "Base URLs saved",
