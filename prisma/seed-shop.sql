...
INSERT INTO "ShopItem" (id, name, description, type, category, price, "spriteKey", "createdAt") VALUES
  -- Colors
  ('gold', 'Golden Shell', 'A shiny golden lobster shell', 'color', 'skin', 100, 'gold', NOW()),
  ...
  -- Hats
  ('crown', 'Crown', 'A royal crown for the top agent', 'hat', 'hat', 200, 'crown', NOW()),
  ...
  ('monocle', 'Monocle', 'Distinguished monocle', 'accessory', 'accessory', 90, 'monocle', NOW()),
