...
const shopItems = [
  // Colors
  { id: "gold", name: "Golden Shell", description: "A shiny golden lobster shell", type: "color", category: "skin", price: 100, spriteKey: "gold" },
  ...
  // Hats
  { id: "crown", name: "Crown", description: "A royal crown for the top agent", type: "hat", category: "hat", price: 200, spriteKey: "crown" },
  ...
  { id: "monocle", name: "Monocle", description: "Distinguished monocle", type: "accessory", category: "accessory", price: 90, spriteKey: "monocle" },
